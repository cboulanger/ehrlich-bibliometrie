# refactor as a class, not functional yet
...
class PyvisNetwork:
    ...
    def draw(self, graph: Graph,
             ...
             auto_rel_label=False,
             **kwargs):
        net = self.create(graph, query, height=height, auto_rel_label=auto_rel_label, **kwargs)
        return self.draw_network(net, file=file, link_only=not do_display)
